package me.elephant1214.paperfixes.mixin.common.world.chunk.smart_region_read;
...
public abstract class RegionFileMixin {
    ...
    @Redirect(method = "<init>", at = @At(value = "INVOKE", target = "Ljava/io/RandomAccessFile;seek(J)V", ordinal = 0))
    ...
    @Redirect(method = "<init>", at = @At(value = "INVOKE", target = "Ljava/io/RandomAccessFile;readInt()I", ordinal = 0))
    private int readHeaderAsInts0(RandomAccessFile raf) {
        return this.paperFixes$header.get();
    }

    @Redirect(method = "<init>", at = @At(value = "INVOKE", target = "Ljava/io/RandomAccessFile;readInt()I", ordinal = 2))
